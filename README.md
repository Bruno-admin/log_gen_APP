...
## Turning the Python Script into a Dockerized app
Use the above **[Dockerfile](Dockerfile)** and run the following command:
```
...
docker build -t log-generator .
```
Use the above **[log_gen_app.yaml](log_gen_app.yaml)** to create the pod:
```
